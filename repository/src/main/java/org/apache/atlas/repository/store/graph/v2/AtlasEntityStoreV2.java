...
public class AtlasEntityStoreV2 implements AtlasEntityStore {
    ...
    public EntityMutationResponse createOrUpdate(EntityStream entityStream, boolean isPartialUpdate) throws AtlasBaseException {
        LOG.info("addlog ---  createOrUpdate");
        System.out.println("addlog ---  createOrUpdate");
    ...
    public void addLabels(String guid, Set<String> labels) throws AtlasBaseException {
        ...
        LOG.info("addlog--v2-createOrUpdate");

        System.out.println("addlog--v2-createOrUpdate");

        if (entityStream == null || !entityStream.hasNext()) {
            LOG.info("addlog--v2-createOrUpdate  no entities to create/update.");
        ...
        for (String guid : discoveryContext.getReferencedGuids()) {
            ...
            if (entity != null) { // entity would be null if guid is not in the stream but referenced by an entity in the stream
                ...
                if (vertex != null) {
                    ...
                    LOG.info(" addlog- guidVertex="+guidVertex);
                    ...
                    LOG.info("addlog--addUpdated  guid="+guid);
